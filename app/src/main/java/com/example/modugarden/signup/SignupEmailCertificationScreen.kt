...
@Composable
fun SignupEmailCertificationScreen(navController: NavHostController, certNumber: String, email: String) {
                ...
                Card(
                    modifier = Modifier
                        .bounceClick {
                            ...
                            Toast.makeText(mContext, "${email}로 인증번호를 재전송했어요", Toast.LENGTH_SHORT).show()
                        },
