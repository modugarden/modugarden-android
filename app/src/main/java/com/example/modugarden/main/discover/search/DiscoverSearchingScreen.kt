...
@Composable
fun DiscoverSearchingScreen(navController: NavHostController, searchText : String) {
        ...
        Column(
            ...
            Row(
                ...
                Image(
                    ...
                    modifier = Modifier
                        .bounceClick {
                            navController.navigate(route = NAV_ROUTE_DISCOVER_SEARCH.DISCOVERSEARCHING.routeName + "/" + textFieldSearch.value, )
                        }
